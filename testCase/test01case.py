...
from utils import geturlParams, readExcel
import urllib.parse
# import pythoncom

# pythoncom.CoInitialize()

url = geturlParams.geturlParams().get_Url() #调用我们的geturlParams获取我们的拼接的URL
...
class testUserLogin(unittest.TestCase):
    ...
    def checkResult(self):
        ...
        #使用  urllib.parse.urlsplit 将url分为5个部分，返回一个包含字符串项目的元组：协议、位置、路径、查询、片段 urllib.parse.parse_qs 返回字典 urllib.parse.parse_qsl 返回列表
        ...
        if  self.case_name == 'login_err': #同上
